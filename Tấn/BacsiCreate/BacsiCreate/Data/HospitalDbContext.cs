...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__Account__349DA586C8F85E51");

            entity.ToTable("Account");

            entity.HasIndex(e => e.Username, "UQ__Account__536C85E4B9351C41").IsUnique();
        ...
        {
            entity.HasKey(e => e.AppointmentId).HasName("PK__Appointm__8ECDFCA22C57899E");
        ...
        {
            entity.HasKey(e => e.BillingId).HasName("PK__Billing__F1656D1385279B6E");
        ...
        {
            entity.HasKey(e => e.DepartmentId).HasName("PK__Departme__B2079BCDF395C3E0");
        ...
        {
            entity.HasKey(e => e.DoctorId).HasName("PK__Doctors__2DC00EDF5E89A053");
        ...
        {
            entity.HasKey(e => e.DoctorSearchId).HasName("PK__DoctorSe__1CAABC051B7BFDA0");
        ...
        {
            entity.HasKey(e => e.EquipmentId).HasName("PK__Equipmen__344745990DD43CCE");
        ...
        {
            entity.HasKey(e => e.RecordId).HasName("PK__MedicalR__FBDF78C9DE20BA9C");
        ...
        {
            entity.HasKey(e => e.MedicationId).HasName("PK__Medicati__62EC1ADA8D3A9FFD");
        ...
        {
            entity.HasKey(e => e.PatientId).HasName("PK__Patients__970EC346145D7650");
        ...
        {
            entity.HasKey(e => e.PrescriptionId).HasName("PK__Prescrip__40130812737BF1EC");
        ...
        {
            entity.HasKey(e => e.RoomId).HasName("PK__Rooms__3286391919550DB3");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__SelectSp__3214EC0736DF42EA");
        ...
        {
            entity.HasKey(e => e.SessionId).HasName("PK__Sessions__C9F49270FB6BAAFE");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__Staff__96D4AAF754B633BD");
